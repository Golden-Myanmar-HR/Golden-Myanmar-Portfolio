      ...
      <div className="py-16 px-4 lg:ps-42 ">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
          <div className="flex-1 space-y-8">
            <h1 className="text-3xl md:text-4xl lg:text-[40px] font-semibold leading-tight text-black">
              Your Pathway from <br /> Myanmar to Japan
              <br />
              <span className="text-black">"Careers Without Borders"</span>
            </h1>
